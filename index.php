...
// Set the page title
tpl_set("page_title","Home Page | Khandan Directory");
...
// Create a new family member object to get a list of users recently added, viewed, and edited
$family_member = new FamilyMember();

// Set the list of users recently add, viewed and edited
tpl_set("recently_added",$family_member->get_recent("add_date"));
tpl_set("recently_viewed",$family_member->get_recent("view_date"));
tpl_set("recently_edited",$family_member->get_recent("edit_date"));

/************************************ End Page Specific Code ********************************************/

// Display the template
tpl_display("tpl/index.tpl");
?>